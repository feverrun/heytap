act_list = [
    ...
    {'act_name': '818周年庆', 'aid': 1506,
     ...
     'extra_draw_cookie': 'app_innerutm={"us":"wode","um":"zuanka","uc":"renwuzhongxin","ut":"direct"};app_utm={"utm_source_app":"direct","utm_campaign_app":"direct","utm_term_app":"direct","utm_medium_app":"direct"};',
     'lid': 1516,
     'draw_times': 3,
    ...
    {'act_name': 'realme积分大乱斗1', 'aid': 1582,
     ...
     'if_draw': False,  # 已修复抽奖，如不需要抽奖请自行修改为False
     'extra_draw_cookie': 'app_innerutm={"us":"wode","um":"zuanka","uc":"direct","ut":"direct"};app_utm={"utm_source":"direct","utm_medium":"direct","utm_campaign":"direct","utm_term":"direct"}',
     'lid': 1546,
     'draw_times': 3,
     'end_time': '2021-9-9 23:59:59',
     'text':'每次扣取10积分'
     },
