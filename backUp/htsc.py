...
class Heytap:
    def __init__(self, config):
        ...
        self.source_type = 501  # 初始化设置为501，会从cookie获取实际数据
        self.sa_distinct_id = ''
        self.sa_device_id = ''
        self.s_version = ''
    ...
    def get_cookie_data(self):
        try:
            ...
            self.s_channel = 'oppo_appstore'
            self.source_type = '501'
    ...
    def realme_lottery(self):
        data = "aid=1182&lid=1429&mobile=&authcode=&captcha=&isCheck=0&source_type=501&s_channel=ios_oppostore&sku=&spu="
